...
//
    ...
    mutating func nexStory(userChoice : String) {
        if userChoice == array[storyNum].choiceOne {
            storyNum = array[storyNum].choice1Dis
        } else {
            storyNum = array[storyNum].choice2Dis
        }
    }
    
    func getTitle() -> String{
        return array[storyNum].title
    }
    func getChoiceOne() -> String{
           return array[storyNum].choiceOne
    }
    func getChoiceTwo() -> String{
        return array[storyNum].choiceTwo
    }
